...
*/
KeyFrameRgbLED rgb4o = KeyFrameRgbLED (6, rgb4u_kf, 11);
KeyFrameRgbLED rgb4u = KeyFrameRgbLED (7, rgb4o_kf, 11);
...
KeyFrameStepper  kfstepper4 = KeyFrameStepper(steppermotor4, astepper4, 4, motor4_kf, 5, 47, true);
