...
TEST(KeyFrame_tests, test1){
    ...
    RGB_EXPECT_EQ(0, kf.getTargetColor().red());
    RGB_EXPECT_EQ(0, kf.getTargetColor().green());
    RGB_EXPECT_EQ(0, kf.getTargetColor().blue());
    ...
    EXPECT_EQ(3300, kf.getTimeMs());
    EXPECT_EQ(0, kf.getTargetPosition());
    RGB_EXPECT_EQ(1000, kf.getTargetColor().red());
    RGB_EXPECT_EQ(2000, kf.getTargetColor().green());
    RGB_EXPECT_EQ(3000, kf.getTargetColor().blue());
    ...
    EXPECT_EQ(3300, kf.getTimeMs());
    EXPECT_EQ(0, kf.getTargetPosition());
    RGB_EXPECT_EQ(500, kf.getTargetColor().red());
    RGB_EXPECT_EQ(1000, kf.getTargetColor().green());
    RGB_EXPECT_EQ(1500, kf.getTargetColor().blue());
    EXPECT_EQ(LEDFRAME, kf.getType());
    ...
    EXPECT_EQ(3300, kf.getTimeMs());
    EXPECT_EQ(0, kf.getTargetPosition());
    RGB_EXPECT_EQ(RGB_MAX_VAL, kf.getTargetColor().red());
    RGB_EXPECT_EQ(RGB_MAX_VAL, kf.getTargetColor().green());
    RGB_EXPECT_EQ(0, kf.getTargetColor().blue());
    EXPECT_EQ(LEDFRAME, kf.getType());
